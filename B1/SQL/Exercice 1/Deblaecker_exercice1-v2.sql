...
SELECT e.emp_no, first_name, last_name, hire_date, SUM(salary) AS sommeSalaire FROM employees e, salaries s WHERE e.emp_no=s.emp_no AND first_name='Richard' GROUP BY salary HAVING SUM(salary)>'100000' ORDER BY last_name;
-- Rqt 22
